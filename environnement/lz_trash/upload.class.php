 ...
 //return 'png';
	...
	try
	   ...
	   //$conn=mysql_connect("localhost","root","") or die(mysql_error());
		...
		$bdd->exec("INSERT INTO lz_fichier(id_file,id_user,nom_file,nom_tag,type_file,size_file,location_file)VALUES('', '$id_user','$FileName','$nom_tag','$extension','$Size ' ,'$location_file')");  
